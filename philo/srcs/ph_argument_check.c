...
/*   Updated: 2025/08/08 11:53:53 by nyts             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ph_argument_check(char **argv, int argc)
{
	...
	if (ph_is_range(ph_atoi(argv[1]), 1, 200) == false
		|| ph_is_range(ph_atoi(argv[2]), 60, INT_MAX) == false
		|| ph_is_range(ph_atoi(argv[3]), 60, INT_MAX) == false
		|| ph_is_range(ph_atoi(argv[4]), 60, INT_MAX) == false
		|| (argc == 6 && ph_is_range(ph_atoi(argv[5]), 0, INT_MAX) == false))
